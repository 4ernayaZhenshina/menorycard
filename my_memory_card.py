...
def checkAnswer():
    if list_btns[0].isChecked():
        ...
        answer.setText('Количество правильный ответов '+ str(window.correct))
        
    else:
        window.incorrect = window.incorrect + 1
        answer.setText('Количество неправильный ответов '+ str(window.incorrect))
...
qlist = [
    Question('Ты тупой?загадка от Жабы Жреско','да', 'бафнув пiлмiни', 'твой айкью 3', 'кнш'),
    Question('Почему?Загадка от Фреско Жака на раздумие 10000 лет', 'воу ты уже на этом вопросе', 'Жак Фреско тупому не научит', 'Какой сейчас век', 'неверно 2' ),
    Question('Как? Загадка Жака Фреско, на раздумие дается 30 сек или слит бот', 'инвалид', 'красивый шрек', 'хачу пельмени', 'старый кадилак'),
    Question('в чем сила','V YKRAINI', 'list_btns[0].setText(q.right_a)', 'гопник(лох09()00)', 'ф222222222222222222222222222222222222222Й2'),
    Question('сколько лет тору', 'пивная бочка', 'гопник', 'как бабке на базаре', 'смазливый школьник'),
    Question('Слава украiни?', 'u gay?', 'гопник???', 'ujgyr', 'да:/?')
]
